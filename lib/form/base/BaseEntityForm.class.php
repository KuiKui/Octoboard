...
abstract class BaseEntityForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'gap_value'      => new sfWidgetFormInputText(),
      'gap_percentage' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'gap_value'      => new sfValidatorNumber(array('required' => false)),
      'gap_percentage' => new sfValidatorNumber(array('required' => false)),
      'history'        => new sfValidatorString(array('max_length' => 1023)),
