...
/**
 * Base class that represents a row from the 'entity' table.
 *
 * 
 *
 * @package    propel.generator.lib.model.om
 */
abstract class BaseEntity extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'EntityPeer';
	...
	/**
	 * The value for the average_value field.
	 * @var        string
	 */
	protected $average_value;

	/**
	 * The value for the average_count field.
	 * @var        int
	 */
	...
	/**
	 * Get the [average_value] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [average_count] column value.
	 * 
	 * @return     int
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = EntityPeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = EntityPeer::NAME;
		}
	...
	public function setValue($v)
	{
		...
		if ($this->value !== $v) {
			$this->value = $v;
			$this->modifiedColumns[] = EntityPeer::VALUE;
		}
	...
	/**
	 * Set the value of [average_value] column.
	 * 
	 * @param      string $v new value
	 * @return     Entity The current object (for fluent API support)
	 */
	public function setAverageValue($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->average_value !== $v) {
			$this->average_value = $v;
			$this->modifiedColumns[] = EntityPeer::AVERAGE_VALUE;
		}
	...
	/**
	 * Set the value of [average_count] column.
	 * 
	 * @param      int $v new value
	 * @return     Entity The current object (for fluent API support)
	 */
	public function setAverageCount($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->average_count !== $v) {
			$this->average_count = $v;
			$this->modifiedColumns[] = EntityPeer::AVERAGE_COUNT;
		}
	...
	public function setHistory($v)
	{
		...
		if ($this->history !== $v) {
			$this->history = $v;
			$this->modifiedColumns[] = EntityPeer::HISTORY;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ($this->created_at !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = EntityPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ($this->updated_at !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = EntityPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = EntityPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = EntityQuery::create()
				->filterByPrimaryKey($this->getPrimaryKey());
			$ret = $this->preDelete($con);
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseEntity:delete:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseEntity:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseEntity:save:pre') as $callable)
			{
			...
			if ($this->isModified() && !$this->isColumnModified(EntityPeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(EntityPeer::CREATED_AT))
				{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseEntity:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				EntityPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(EntityPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(EntityPeer::NAME)) {
			$modifiedColumns[':p' . $index++]  = '`NAME`';
		}
		if ($this->isColumnModified(EntityPeer::VALUE)) {
			$modifiedColumns[':p' . $index++]  = '`VALUE`';
		}
		if ($this->isColumnModified(EntityPeer::AVERAGE_VALUE)) {
			$modifiedColumns[':p' . $index++]  = '`AVERAGE_VALUE`';
		}
		...
		if ($this->isColumnModified(EntityPeer::UPDATED_AT)) {
			$modifiedColumns[':p' . $index++]  = '`UPDATED_AT`';
		}

		$sql = sprintf(
			'INSERT INTO `entity` (%s) VALUES (%s)',
			...
			foreach ($modifiedColumns as $identifier => $columnName) {
				switch ($columnName) {
					...
					case '`VALUE`':
						...
						break;
					case '`AVERAGE_VALUE`':
						$stmt->bindValue($identifier, $this->average_value, PDO::PARAM_STR);
						break;
					case '`AVERAGE_COUNT`':
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = EntityPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = EntityPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Entity'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Entity'][$this->getPrimaryKey()] = true;
		$keys = EntityPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EntityPeer::ID)) $criteria->add(EntityPeer::ID, $this->id);
		if ($this->isColumnModified(EntityPeer::NAME)) $criteria->add(EntityPeer::NAME, $this->name);
	...
	{
		$criteria = new Criteria(EntityPeer::DATABASE_NAME);
		$criteria->add(EntityPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Entity (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Entity Clone of current object.
	 * @throws     PropelException
	 */
	...
	{
		return (string) $this->exportTo(EntityPeer::DEFAULT_STRING_FORMAT);
	}
	...
	public function __call($name, $params)
	{
		...
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseEntity:' . $name))
		{
